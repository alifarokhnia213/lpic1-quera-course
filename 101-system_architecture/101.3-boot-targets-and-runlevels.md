...
# Table Of Contents:
- [Section Description](#section-1013-change-runlevels-and-boot-targets-and-shutdown-or-reboot-the-system)
- [Key Knowledge areas](#key-knowledge-areas)
- [Used files, terms & utilities](#a-partial-list-of-the-used-files-terms-and-utilities)

### 101.3 - Part 1
- [Runlevels](#runlevels)
  - [Systemd](#systemd)
  - [SysVinit Runlevels](#sysvinit-runlevels)
  - [Checking status & Setting defaults](#checking-status-and-setting-defaults)
  - [/etc/inittab](#etc-inittab)
- [Notes](#part-1-notes)

### 101.3 - Part 2
- [Stopping The System](#stopping-the-system)
  - [Halt, Reboot & Poweroff](#halt-reboot-and-poweroff)
- [ACPI](#advanced-configuration-and-power-interface)
- [Notifying the users](#notifying-the-users)
- [Notes](#part-2-notes)
